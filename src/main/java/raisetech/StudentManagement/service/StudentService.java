...
public class StudentService {
  ...
  /**
   * 受講生検索です。
   * IDに紐づく受講生情報を取得したあと、その受講生に紐付く受講生コース情報を取得して設定します。
   *
   * @param id　受講生ID
   * @return 受講生詳細
   */
  public StudentDetail searchStudent(int id){
    ...
    List<StudentsCourses> studentCourseList = repository.searchStudentCourse(student.getId());
  ...
  /**
   * 受講生詳細の登録を行います。
   * 受講生と受講生コース情報を個別に登録し、受講生コース情報には受講生情報を紐づける値とコース開始日とコース終了日を設定します。
  ...
  public StudentDetail registerStudent(StudentDetail studentDetail){
    ...
    for (StudentsCourses studentsCourse : studentDetail.getStudentCourseList()) {
